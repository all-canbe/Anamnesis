---
id: "k15"
slug: "humanizer-zh-editing-skill"
title: "Humanizer-zh: 去除中文AI写作痕迹的编辑技能"
date: "2026-06-05"
category: "ai"
summary: "基于维基百科AI写作特征整理的24种AI文本模式识别与改写指南，帮助去除中文文本的AI味，让文字更自然有人味。"
format: "md"
---
---
name: humanizer-zh
description: 去除中文文本中的 AI 写作痕迹。**触发条件**：用户贴出一段中文文本要求"去 AI 味"、"改得更像人写的"、"humanize"、"humanizer"，或文本明显是 AI 生成（含"此外""值得注意的是""不仅仅是…而是""——"等模式）。不适用于：英文文本、技术代码、纯数据。
---
