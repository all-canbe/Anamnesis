...
function makeConfig(): AgentConfig {
  return { baseUrl: "https://api.test.com/v1", apiKey: "sk-test", model: "test-model", embeddingBaseUrl: "https://api.test.com/v1", embeddingApiKey: "", embeddingModel: "BAAI/bge-m3", zvecEnabled: false };
}
